...
export type ViteHandle = {
     ...
     */
    baseUrl?: string;
} & (DevelopmentViteBuild | ProductionViteBuild);
/**
 ...
 */
export declare function getWidgetHTML(widgetName: string, viteHandle: ViteHandle): Promise<string>;
/**
...
export declare function chatGPTWidgetPlugin(options?: ChatGPTWidgetPluginOptions): VitePlugin;
export {};
